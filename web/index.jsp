...
<head>
  ...
  <link rel="stylesheet" href="decode/assets/bootstrap/css/bootstrap.min.css">
  ...
  <link rel="shortcut icon" href="decode/assets/ico/favicon.png">
  ...
  <div class="container layouts">
    ...
    <div class="row">
      <div class="col-sm-10 col-sm-offset-2">
        <div class="row">
          <div class="col-sm-5 layout-box">
            <a href="encryption/index.jsp">
              <img src="choose-layout-assets/1.jpg" alt="">
            </a>
            <p>加密/隐藏</p>
          </div>
          <div class="col-sm-5 layout-box">
            <a href="decode/index.jsp">
